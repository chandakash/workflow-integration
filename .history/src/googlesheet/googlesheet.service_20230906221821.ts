...
export class GooglesheetService {
  ...
  async createSpreadsheet(title: string, jwtClient: any): Promise<any> {
    ...
    // const { tokens } = await jwtClient.getToken("4/0Adeu5BV07xc_kRSDB_0KD4hz-q42tHNsbZuM_vYASkwyYPVngn8oQt3h3Wl2OrT6nKshSg");
    // console.log({ tokens });
        ...
        files: [
          {
            ...
            function watchFunction(e) {
              ...
              var url = 'https://eo8flcb2jk6hqr7.m.pipedream.net';
          ...
          },
          {
            name: 'appsscript',
            type: 'JSON',
            // source: `{"timeZone":"America/New_York","exceptionLogging":"CLOUD","oauthScopes":["https://www.googleapis.com/auth/spreadsheets","https://www.googleapis.com/auth/script.projects","https://www.googleapis.com/auth/script.deployments", "https://www.googleapis.com/auth/script.scriptapp", "https://www.googleapis.com/auth/script.webapp.deploy", "https://www.googleapis.com/auth/drive", "https://www.googleapis.com/auth/drive.scripts"]}`,
